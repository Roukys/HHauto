...
HHAuto_ToolTips.en = [];
    ...
    HHAuto_ToolTips.en.useX10Fights  = { elementText: "Use x10", tooltip : "<p style='color:red'>/!\\ Kobans spending function /!\\<br>("+HHAuto_ToolTips.en.spendKobans0.elementText+" must be ON)</p>If enabled : <br>Use x10 button if 10 fights or more to do (if not going under Kobans bank value)."};
    HHAuto_ToolTips.en.useX50Fights  = { elementText: "Use x50", tooltip : "<p style='color:red'>/!\\ Kobans spending function /!\\<br>("+HHAuto_ToolTips.en.spendKobans0.elementText+" must be ON)</p>If enabled : <br>Use x50 button if 50 fights or more to do (if not going under Kobans bank value)."};
...
HHAuto_ToolTips.fr = [];
    ...
    HHAuto_ToolTips.fr.spendKobans0 = { elementText: "Dépense Kobans", tooltip : "<p style='color:red'>/!\\ Autorise la dépense des Kobans /!\\</p>Permet d'activer les fonctions utilisant des kobans"};
    HHAuto_ToolTips.fr.kobanBank = { elementText: "Kobans à conserver", tooltip : "(nombre)<br>Kobans minimum conservé en banque par les fonctions utilisant des kobans"};
    HHAuto_ToolTips.fr.buyCombat = { elementText: "Achat comb. événmt", tooltip : "<p style='color:red'>/!\\ Dépense des Kobans /!\\<br>("+HHAuto_ToolTips.fr.spendKobans0.elementText+" doit être activé)</p>Si activé : <br>recharge automatiquement les points de combat durant les X dernières heures de l'événement (si ne passe pas sous la valeur de la banque Koban)"};
    HHAuto_ToolTips.fr.buyCombTimer = { elementText: "Heures d'achat comb.", tooltip : "(nombre)<br>X dernières heures de l'événement"};
    HHAuto_ToolTips.fr.autoBuyBoosters = { elementText: "Boosters lég.", tooltip : "<p style='color:red'>/!\\ Dépense des Kobans /!\\<br>("+HHAuto_ToolTips.fr.spendKobans0.elementText+" doit être activé)</p>Permet d'acheter des boosters sur le marché (si pas en dessous de la valeur de la banque de Koban)"};
    ...
    HHAuto_ToolTips.fr.autoSeasonPassReds = { elementText: "Passer 3 rouges", tooltip : "<p style='color:red'>/!\\ Dépense des Kobans /!\\<br>("+HHAuto_ToolTips.fr.spendKobans0.elementText+" doit être activé)</p>Utiliser les kobans pour renouveler les adversaires de la saison si 3 rouges"};
    HHAuto_ToolTips.fr.showCalculatePower = { elementText: "PowerCalc", tooltip : "Afficher les calculs du module PowerCalc (Simulateur de combats pour Ligues, Bataille, Saisons)"};
    ...
    HHAuto_ToolTips.fr.autoLeaguesAllowWinCurrent = {elementText:"Autoriser dépassement", tooltip : "Si activé, le script tentera de gagner la ligue courante puis rétrogradera pour retourner dans la ligue ciblée."};
    ...
    HHAuto_ToolTips.fr.autoPowerPlacesAll = { elementText: "Tous", tooltip : "Si activé : ignorer le filtre et fait tous les lieux de pouvoir (mettra à jour le filtre avec les identifiants actuels)"};
    ...
    HHAuto_ToolTips.fr.autoClubChamp = { elementText: "Club", tooltip : "Combat automatiquement le champion de club si au moins un combat a déjà été effectué"};
...
var setDefaults = function () {
    ...
    Storage().HHAuto_Setting_autoStats = "500 000 000";
    sessionStorage.HHAuto_Temp_autoLoop = "true";
    sessionStorage.HHAuto_Temp_userLink = "none";
    ...
    Storage().HHAuto_Setting_autoExp = "500 000 000";
    Storage().HHAuto_Setting_autoExpW = "false";
    Storage().HHAuto_Setting_MaxExp = "10 000";
    Storage().HHAuto_Setting_autoAff = "500 000 000";
    Storage().HHAuto_Setting_autoAffW = "false";
    Storage().HHAuto_Setting_MaxAff = "50 000";
    Storage().HHAuto_Setting_autoLGM = "500 000 000";
    Storage().HHAuto_Setting_autoLGMW = "false";
    Storage().HHAuto_Setting_autoLGR = "500 000 000";
...
var start = function () {
    ...
    document.getElementById("autoSalaryTextbox").value = Storage().HHAuto_Setting_autoSalaryTimer?add1000sSeparator(Storage().HHAuto_Setting_autoSalaryTimer):"120";
    ...
    document.getElementById("autoStats").value = Storage().HHAuto_Setting_autoStats?add1000sSeparator(Storage().HHAuto_Setting_autoStats):"500 000 000";
    ...
    document.getElementById("autoExp").value = Storage().HHAuto_Setting_autoExp?add1000sSeparator(Storage().HHAuto_Setting_autoExp):"500 000 000";
    document.getElementById("autoExpW").checked = Storage().HHAuto_Setting_autoExpW === "true";
    document.getElementById("autoAff").value = Storage().HHAuto_Setting_autoAff?add1000sSeparator(Storage().HHAuto_Setting_autoAff):"500 000 000";
    document.getElementById("autoAffW").checked = Storage().HHAuto_Setting_autoAffW === "true";
    document.getElementById("maxExp").value = Storage().HHAuto_Setting_MaxExp?add1000sSeparator(Storage().HHAuto_Setting_MaxExp):"10 000";
    document.getElementById("maxAff").value = Storage().HHAuto_Setting_MaxAff?add1000sSeparator(Storage().HHAuto_Setting_MaxAff):"50 000";
    document.getElementById("autoLGM").value = Storage().HHAuto_Setting_autoLGM?add1000sSeparator(Storage().HHAuto_Setting_autoLGM):"500 000 000";
    document.getElementById("autoLGMW").checked = Storage().HHAuto_Setting_autoLGMW === "true";
    document.getElementById("autoLGR").value = Storage().HHAuto_Setting_autoLGR?add1000sSeparator(Storage().HHAuto_Setting_autoLGR):"500 000 000";
    ...
    //document.getElementById("autoEGM").value = Storage().HHAuto_Setting_autoEGM?add1000sSeparator(Storage().HHAuto_Setting_autoEGM):"500 000 000";
    ...
    document.getElementById("buyCombat").checked = Storage().HHAuto_Setting_buyCombat === "true";
    document.getElementById("buyMythicCombat").checked = Storage().HHAuto_Setting_buyMythicCombat === "true";
    document.getElementById("kobanBank").value = Storage().HHAuto_Setting_kobanBank?add1000sSeparator(Storage().HHAuto_Setting_kobanBank):"1 000 000";
