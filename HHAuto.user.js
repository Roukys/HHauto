    ...
    if (getPage() === "battle") {
        ...
        if ($("#battle[class='canvas']").length === 1) {
            ...
            if(currentPower >= battle_price)
            {
                ...
                setTimeout(function(){gotoPage("home")},3000);
                return true;
            }
            else
            {
