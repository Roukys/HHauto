...
HHAuto_ToolTips.fr = [];
    ...
    HHAuto_ToolTips.fr.kobanBank = { elementText: "Kobans à conserver", tooltip : "(nombre)<br>Minimum de Kobans conservé en banque par les fonctions utilisant des kobans.<br>Ces fonctions ne s'exécuteront pas si elles risquent de faire passer la réserve de kobans sous cette limite."};
    ...
    HHAuto_ToolTips.fr.showCalculatePower = { elementText: "PowerCalc", tooltip : "Si activé : affiche le résultat des calculs du module PowerCalc (Simulateur de combats pour Ligues, Bataille, Saisons)."};
