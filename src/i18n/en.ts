...
HHAuto_ToolTips.en['showHaremAvatarMissingGirls'] = { version: "8.10.42", elementText: "Show avatar", tooltip: "Show Avatar for missing girls in Harem"};
HHAuto_ToolTips.en['showHaremTools'] = { version: "8.10.42", elementText: "Show tools", tooltip: "Show grils tools in Harem"};
HHAuto_ToolTips.en['showHaremSkillsButtons'] = { version: "8.10.42", elementText: "Show skills buttons", tooltip: "Show upgrade skill buttons in Harem"};
HHAuto_ToolTips.en['autoActivitiesTitle'] = { version: "8.10.42", elementText: "Missions"};
...
HHAuto_ToolTips.en['autoMission'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically do missions"};
...
HHAuto_ToolTips.en['autoTrollBattle'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically battle standard troll selected"};
...
HHAuto_ToolTips.en['autoChampsForceStartEventGirl'] = { version: "8.10.42", elementText: "Force event girl", tooltip: "if enabled, will fight for event girl champion even if not started. Champions will need to be activated and champions to be in the filter."};
...
HHAuto_ToolTips.en['plusEvent'] = { version: "8.10.42", elementText: "Enabled", tooltip: "Fight regular event trolls independently from Auto Troll.<br>Respects energy threshold."};
HHAuto_ToolTips.en['plusEventMythic'] = { version: "8.10.42", elementText: "Enabled", tooltip: "Fight mythic event trolls independently from Auto Troll.<br>Bypasses energy threshold. Prioritized over regular events."};
...
HHAuto_ToolTips.en['autoSeason'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically fight in Seasons (Opponent chosen following PowerCalculation)"};
...
HHAuto_ToolTips.en['autoQuest'] = { version: "8.10.42", elementText: "Main quests", tooltip: "if enabled : Automatically do main quest"};
HHAuto_ToolTips.en['autoSideQuest'] = { version: "8.10.42", elementText: "Side quests", tooltip: "if enabled : Automatically do next available side quest (Enabled main quest has higher priority than side quests)"};
...
HHAuto_ToolTips.en['autoContest'] = { version: "8.10.42", elementText: "Collect", tooltip: "if enabled : Collect finished contest rewards"};
...
HHAuto_ToolTips.en['autoFreePachinko'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically collect free Pachinkos"};
...
HHAuto_ToolTips.en['autoLeagues'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically battle Leagues"};
...
HHAuto_ToolTips.en['autoPowerPlaces'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically Do powerPlaces"};
...
HHAuto_ToolTips.en['autoPowerPlacesAll'] = { version: "8.10.42", elementText: "Do all", tooltip: "If enabled : ignore filter and do all powerplaces (will update Filter with current ids)"};
...
HHAuto_ToolTips.en['autoChamps'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically do champions (if they are started and in filter only)"};
...
HHAuto_ToolTips.en['autoStatsSwitch'] = { version: "8.10.42", elementText: "Buy stats", tooltip: "Allow to on/off autoStats"};
HHAuto_ToolTips.en['autoExpW'] = { version: "8.10.42", elementText: "Buy books", tooltip: "if enabled : allow to buy Exp in market<br>Only buy if money bank is above the value<br>Only buy if total Exp owned is below value"};
...
HHAuto_ToolTips.en['autoAffW'] = { version: "8.10.42", elementText: "Buy gifts", tooltip: "if enabled : allow to buy Aff in market<br>Only buy if money bank is above the value<br>Only buy if total Aff owned is below value"};
...
HHAuto_ToolTips.en['showClubButtonInPoa'] = { version: "8.10.42", elementText: "Go to in events", tooltip: "if enabled, add a 'go to' button in Event related objectives."};
HHAuto_ToolTips.en['autoClubChamp'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled, automatically fight club champion if champion has already been fought once."};
...
HHAuto_ToolTips.en['autoTrollMythicByPassParanoia'] = { version: "8.10.42", elementText: "Mythic bypass paranoia", tooltip: "Allow mythic to bypass paranoia.<br>if next wave is during rest, it will force it to wake up for wave.<br>If still fight or can buy fights it will continue."};
HHAuto_ToolTips.en['buyMythicCombat'] = { version: "8.10.42", elementText: "Buy comb. for mythic", tooltip: "<p style='color:red'>/!\\ Kobans spending function /!\\<br>("+HHAuto_ToolTips.en['spendKobans0'].elementText+" must be ON)</p>If enabled : <br>Buying combat point during last X hours of mythic event (if not going under Koban bank value), this will bypass threshold if mythic girl shards available."};
...
HHAuto_ToolTips.en['autodpEventCollectAll'] = { version: "8.10.42", elementText: "Collect all", tooltip: "if enabled : Automatically collect all items before end of double penetration event (configured with Collect all timer)"};
...
HHAuto_ToolTips.en['autoLivelySceneEventCollectAll'] = { version: "8.10.42", elementText: "Collect all", tooltip: "if enabled : Automatically collect all items before end of Lively Scene event (configured with Collect all timer)" };
HHAuto_ToolTips.en['sultryMysteriesEventRefreshShop'] = { version: "8.10.42", elementText: "Refresh shop", tooltip: "Open Sultry Mysteries shop tab to trigger shop update."};
...
HHAuto_ToolTips.en['useX10FightsAllowNormalEvent'] = { version: "8.10.42", elementText: "x10 for event", tooltip: "If off:<br> X10 will only be used for mythic event<br>If enabled : <br>Allow x10 button for normal event if 10 fights or more to do (if not going under Koban bank value).<br>x50 takes precedence on x10 if all conditions are filled."};
HHAuto_ToolTips.en['useX50FightsAllowNormalEvent'] = { version: "8.10.42", elementText: "x50 for event", tooltip: "If off:<br> X50 will only be used for mythic event<br>If enabled : <br>Use x50 button for normal event if 50 fights or more to do (if not going under Koban bank value).<br>Takes precedence on x10 if all conditions are filled."};
...
HHAuto_ToolTips.en['autoLabyrinth'] = { version: "8.10.42", elementText: "Enabled", tooltip: "if enabled : Automatically do Labyrinth simple mode.<br/>Will select easiest opponent not looking for later step."};
...
HHAuto_ToolTips.en['autoPoGCollectAll'] = { version: "8.10.42", elementText: "Collect all", tooltip: "if enabled : Automatically collect all items before end of Path of Glory (configured with Collect all timer)"};
...
HHAuto_ToolTips.en['autoPoACollectAll'] = { version: "8.10.42", elementText: "Collect all", tooltip: "if enabled : Automatically collect all items before end of Path of Attraction event (configured with Collect all timer)"};
HHAuto_ToolTips.en['dailyGoalsTitle'] = {version: "5.24.0", elementText: "Daily Goals"};
HHAuto_ToolTips.en['autoDailyGoals'] = {version: "8.10.42", elementText: "Enabled", tooltip: "BETA: Perform supported daily goals <br>(Currently: Pantheon)."};
...
HHAuto_ToolTips.en['collectAllTimer'] = {version: "8.10.42", elementText: "Collect all timer", tooltip: "Hour(s) before end of events to collect all rewards (Low time create risk of not collecting), Need activation on each events (POV, POG, season)"};
