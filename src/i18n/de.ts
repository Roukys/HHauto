...
HHAuto_ToolTips.de['autoTrollBattle'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv: Macht automatisch Kämpfe gegen den Standard-Troll"};
...
HHAuto_ToolTips.de['plusEvent'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Kämpft gegen normale Event-Trolle unabhängig von Auto-Troll.<br>Die Energie-Schwelle wird beachtet."};
HHAuto_ToolTips.de['plusEventMythic'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Kämpft gegen Mythic-Event-Trolle unabhängig von Auto-Troll.<br>Übergeht die Energie-Schwelle. Hat Vorrang vor normalen Events."};
...
HHAuto_ToolTips.de['autoTrollMythicByPassParanoia'] = { version: "8.10.42", elementText: "Mythisch über Paranoia", tooltip: "Wenn aktiv: Erlaubt es den Paranoia Modus zu übergehen. Wenn du noch kämpfen kannst oder dir Energie kaufen kannst, wird gekämpft. Sollte die nächste Welle an Splittern während der Ruhephase sein, wird der Modus unterbrochen und es wird gekämpft"};
HHAuto_ToolTips.de['autoSeason'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv : Kämpft automatisch in der Saison (Gegner werden wie im Kraftrechner einstellt gewählt)"};
...
HHAuto_ToolTips.de['autoQuest'] = { version: "8.10.42", elementText: "Hauptquests", tooltip: "Wenn aktiv: Erledigt die Hauptquest automatisch."};
...
HHAuto_ToolTips.de['autoContest'] = { version: "8.10.42", elementText: "Einsammeln", tooltip: "Wenn aktiv: sammelt abgeschlossene Wettbewerbsbelohnungen ein."};
HHAuto_ToolTips.de['autoFreePachinko'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv: dreht das kostenlose Pachinko und sammelt den Gewinn ein."};
HHAuto_ToolTips.de['autoLeagues'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv : Kämpft automatisch in der Liga"};
...
HHAuto_ToolTips.de['autoPowerPlaces'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv : macht automatisch Orte der Macht"};
...
HHAuto_ToolTips.de['autoPowerPlacesAll'] = { version: "8.10.42", elementText: "Mach alle", tooltip: "Wenn aktiv : ignoriere Filter und mache alle (aktualisiert den Filter mit korrekten IDs)"};
HHAuto_ToolTips.de['autoChamps'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv: kämpft automatisch gegen normale Champions, sofern sie gestartet wurden und im Filter stehen."};
...
HHAuto_ToolTips.de['autoClubChamp'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv: kämpft automatisch gegen den Club-Champion, sofern er gestartet wurde."};
...
HHAuto_ToolTips.de['autoExpW'] = { version: "8.10.42", elementText: "Bücher kaufen", tooltip: "Wenn aktiv: kauft Bücher im Markt.<br>Kauft nur, wenn dein Geld über dem gesetzten Wert liegt und dein Vorrat unter der eingestellten Menge."};
...
HHAuto_ToolTips.de['autoAffW'] = { version: "8.10.42", elementText: "Geschenke kaufen", tooltip: "Wenn aktiv: kauft Geschenke im Markt.<br>Kauft nur, wenn dein Geld über dem gesetzten Wert liegt und dein Vorrat unter der eingestellten Menge."};
...
HHAuto_ToolTips.de['showHaremAvatarMissingGirls'] = { version: "8.10.42", elementText: "Avatar zeigen", tooltip: "Zeigt im Harem den Avatar für fehlende Mädels."};
HHAuto_ToolTips.de['showHaremTools'] = { version: "8.10.42", elementText: "Werkzeuge zeigen", tooltip: "Zeigt die Mädel-Werkzeuge im Harem."};
HHAuto_ToolTips.de['showHaremSkillsButtons'] = { version: "8.10.42", elementText: "Skill-Knöpfe zeigen", tooltip: "Zeigt im Harem die Knöpfe zum Verbessern der Skills."};
HHAuto_ToolTips.de['autoActivitiesTitle'] = { version: "8.10.42", elementText: "Missionen"};
...
HHAuto_ToolTips.de['showInfoLeft'] = { version: "8.10.42", elementText: "Info links zeigen", tooltip: "Zeigt die Info auf der linken statt auf der rechten Seite."};
...
HHAuto_ToolTips.de['autoChampsForceStartEventGirl'] = { version: "8.10.42", elementText: "Event-Mädel erzwingen", tooltip: "Wenn aktiv, wird auch gegen einen noch nicht gestarteten Champion gekämpft, sofern er ein Event-Mädel hat. Champions müssen aktiviert und im Filter sein."};
...
HHAuto_ToolTips.de['autoSideQuest'] = { version: "8.10.42", elementText: "Nebenquests", tooltip: "Wenn aktiv: Erledigt automatisch die nächste verfügbare Nebenquest (eine aktivierte Hauptquest hat Vorrang)."};
...
HHAuto_ToolTips.de['autoStatsSwitch'] = { version: "8.10.42", elementText: "Werte kaufen", tooltip: "Schaltet autoStats an und aus."};
...
HHAuto_ToolTips.de['showClubButtonInPoa'] = { version: "8.10.42", elementText: "'Gehe zu' in Events", tooltip: "Wenn aktiv: Fügt bei Event-Zielen einen 'Gehe zu'-Knopf ein."};
...
HHAuto_ToolTips.de['buyMythicCombat'] = { version: "8.10.42", elementText: "Kämpfe kaufen (Mythisch)", tooltip: "<p style='color:red'>/!\\ Kobans ausgeben /!\\<br>("+HHAuto_ToolTips.de['spendKobans0'].elementText+" muss AN sein)</p> Wenn aktiv: Kauft Kampfpunkte während eines Mythic-Events."};
...
HHAuto_ToolTips.de['autodpEventCollectAll'] = { version: "8.10.42", elementText: "Alles einsammeln", tooltip: "Wenn aktiv: Sammelt vor Ende des Double-Penetration-Events automatisch alle Belohnungen ein (Zeitpunkt über 'Alles einsammeln'-Timer)."};
...
HHAuto_ToolTips.de['autoLivelySceneEventCollectAll'] = { version: "8.10.42", elementText: "Alles einsammeln", tooltip: "Wenn aktiv: Sammelt vor Ende des Lively-Scene-Events automatisch alle Belohnungen ein (Zeitpunkt über 'Alles einsammeln'-Timer)."};
HHAuto_ToolTips.de['sultryMysteriesEventRefreshShop'] = { version: "8.10.42", elementText: "Shop auffrischen", tooltip: "Öffnet den Sultry-Mysteries-Shop-Reiter, um die Shop-Aktualisierung auszulösen."};
...
HHAuto_ToolTips.de['useX10FightsAllowNormalEvent'] = { version: "8.10.42", elementText: "x10 für Events", tooltip: "Wenn aus:<br>x10 wird nur bei Mythic-Events genutzt.<br>Wenn aktiv:<br>x10 ist auch bei normalen Events erlaubt."};
HHAuto_ToolTips.de['useX50FightsAllowNormalEvent'] = { version: "8.10.42", elementText: "x50 für Events", tooltip: "Wenn aus:<br>x50 wird nur bei Mythic-Events genutzt.<br>Wenn aktiv:<br>x50 ist auch bei normalen Events erlaubt."};
...
HHAuto_ToolTips.de['autoLabyrinth'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "Wenn aktiv: Spielt das Labyrinth im einfachen Modus.<br/>Wählt den leichtesten Gegner, ohne nach Belohnung zu schauen."};
...
HHAuto_ToolTips.de['autoPoGCollectAll'] = { version: "8.10.42", elementText: "Alles einsammeln", tooltip: "Wenn aktiv: Sammelt vor Ende des Path of Glory automatisch alle Belohnungen ein (Zeitpunkt über 'Alles einsammeln'-Timer)."};
...
HHAuto_ToolTips.de['autoPoACollectAll'] = { version: "8.10.42", elementText: "Alles einsammeln", tooltip: "Wenn aktiv: Sammelt vor Ende des Path-of-Attraction-Events automatisch alle Belohnungen ein (Zeitpunkt über 'Alles einsammeln'-Timer)."};
HHAuto_ToolTips.de['dailyGoalsTitle'] = { version: "5.24.0", elementText: "Tagesziele"};
HHAuto_ToolTips.de['autoDailyGoals'] = { version: "8.10.42", elementText: "Aktiviert", tooltip: "BETA: Erledigt unterstützte Tagesziele <br>(derzeit: Pantheon)."};
...
HHAuto_ToolTips.de['collectAllTimer'] = { version: "8.10.42", elementText: "Timer Alles einsammeln", tooltip: "Stunde(n) vor Ende eines Events, ab der alle Belohnungen eingesammelt werden (ein knapper Wert ist riskant)."};
