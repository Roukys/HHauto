...
HHAuto_ToolTips.de['showCalculatePower'] = { version: "8.10.0", elementText: "PowerCalc", tooltip: "Zeigt den Kampfsimulator bei Liga, Kampf und Season an."};
...
HHAuto_ToolTips.de['autoSeason'] = { version: "8.10.0", elementText: "Aktivieren", tooltip: "Wenn aktiv : Kämpft automatisch in der Season (Gegner werden wie im Kraftrechner einstellt gewählt)"};
...
HHAuto_ToolTips.de['sandalwoodMinShardsThreshold'] = { version: "8.10.0", elementText: "SW min. Shards", tooltip: "Kein Sandalwood mehr ausrüsten, wenn verbleibende Shards diesen Wert erreichen oder unterschreiten. 0 = Sandalwood immer ausrüsten."};
...
HHAuto_ToolTips.de['plusGirlSkins'] = { version: "7.32.5", elementText: "+Mädel-Skins", tooltip: "Kämpft weiter, nachdem die Shards komplett sind, um die Skins des Mädels zu sammeln.<br>Gilt für Events und Raids.<br>Wenn aus: Schluss, sobald die Shards voll sind."};
...
HHAuto_ToolTips.de['minShardsX50'] = { version: "8.10.0", elementText: "Min. Shards x50", tooltip: "Der x50-Knopf wird nur genutzt, wenn beim aktuellen Mädel mindestens so viele Shards fehlen."};
HHAuto_ToolTips.de['minShardsX10'] = { version: "8.10.0", elementText: "Min. Shards x10", tooltip: "Der x10-Knopf wird nur genutzt, wenn beim aktuellen Mädel mindestens so viele Shards fehlen."};
