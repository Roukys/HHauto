...
HHAuto_ToolTips.fr['showInfoLeft'] = { version: "8.10.42", elementText: "Infos à gauche", tooltip: "Affiche la fenêtre d'information à gauche plutot qu'à droite"};
...
HHAuto_ToolTips.fr['autoPowerPlacesAll'] = { version: "8.10.42", elementText: "Tous", tooltip: "Si activé : ignore le filtre et fait tous les lieux de pouvoir (mettra à jour le filtre avec les identifiants actuels)"};
...
HHAuto_ToolTips.fr['autodpEventCollectAll'] = { version: "8.10.42", elementText: "Tout collecter", tooltip: "Si activé : Collect Automatiquement toutes les récompense avant la fin de l'évènement double penetration (configuré avec le timer \"Tout collecter\")"};
...
HHAuto_ToolTips.fr['autoPoVCollectAll'] = { version: "8.10.42", elementText: "Tout collecter", tooltip: "Si activé : Collect Automatiquement toutes les récompense avant la fin de la Voie de la Valeur (configuré avec le timer \"Tout collecter\")"};
...
HHAuto_ToolTips.fr['autoPoGCollectAll'] = { version: "8.10.42", elementText: "Tout collecter", tooltip: "Si activé : Collect Automatiquement toutes les récompense avant la fin de la Voie de la Gloire (configuré avec le timer \"Tout collecter\")"};
...
HHAuto_ToolTips.fr['autoPoACollectAll'] = { version: "8.10.42", elementText: "Tout collecter", tooltip: "Si activé : Collect Automatiquement toutes les récompense avant la fin de l'event chemin d'affection (configuré avec le timer \"Tout collecter\")"};
...
HHAuto_ToolTips.fr['autoTrollMythicByPassParanoia'] = { version: "8.10.42", elementText: "Mythique annule paranoïa", tooltip: "Si activé : autorise le script à ne pas respecter le mode Parano lors d'un événement mythique.<br>Si la prochaine vague est pendant une phase de sommeil le script combattra quand même<br>tant que des combats et des fragments sont disponibles."};
...
HHAuto_ToolTips.fr['showHaremAvatarMissingGirls'] = { version: "8.10.42", elementText: "Afficher l'avatar", tooltip: "Affiche l'avatar des filles manquantes dans le harem."};
HHAuto_ToolTips.fr['showHaremTools'] = { version: "8.10.42", elementText: "Afficher les outils", tooltip: "Affiche les outils des filles dans le harem."};
HHAuto_ToolTips.fr['showHaremSkillsButtons'] = { version: "8.10.42", elementText: "Afficher les boutons de compétence", tooltip: "Affiche les boutons d'amélioration des compétences dans le harem."};
...
HHAuto_ToolTips.fr['showClubButtonInPoa'] = { version: "8.10.42", elementText: "« Aller à » dans les événements", tooltip: "Si activé : ajoute un bouton « aller à » dans les objectifs liés aux événements."};
...
HHAuto_ToolTips.fr['hideOwnedGirls'] = { version: "8.10.42", elementText: "Masquer les filles possédées", tooltip: "Masque les filles déjà possédées sur la page d'événement, quand l'événement compte plus de 30 filles à gagner et que vous en avez déjà plus de 10."};
...
HHAuto_ToolTips.fr['autoLivelySceneEventCollectAll'] = { version: "8.10.42", elementText: "Tout récupérer", tooltip: "Si activé : récupère automatiquement tous les objets avant la fin de l'événement Scène animée (selon le minuteur Tout récupérer)."};
HHAuto_ToolTips.fr['sultryMysteriesEventRefreshShop'] = { version: "8.10.42", elementText: "Rafraîchir la boutique", tooltip: "Ouvre l'onglet boutique des Mystères Sensuels pour forcer sa mise à jour."};
