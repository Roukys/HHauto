...
HHAuto_ToolTips.fr['plusEvent'] = { version: "7.32.1", elementText: "+Événement", tooltip: "Combat les trolls d'événement normaux indépendamment d'Auto Troll.<br>Respecte le seuil d'énergie."};
HHAuto_ToolTips.fr['plusEventMythic'] = { version: "7.32.1", elementText: "+Événement mythique", tooltip: "Combat les trolls d'événement mythiques indépendamment d'Auto Troll.<br>Ignore le seuil d'énergie. Prioritaire sur les événements normaux."};
...
HHAuto_ToolTips.fr['autoQuest'] = { version: "5.6.74", elementText: "Quête principale", tooltip: "Si activé : effectue automatiquement la quête principale."};
...
HHAuto_ToolTips.fr['autoFreePachinko'] = { version: "5.6.24", elementText: "Pachinko", tooltip: "Si activé : récupère automatiquement les Pachinkos gratuits."};
...
HHAuto_ToolTips.fr['autoChamps'] = { version: "5.6.24", elementText: "Normal", tooltip: "Si activé : effectue automatiquement les champions (seulement s'ils sont commencés et présents dans le filtre)."};
...
HHAuto_ToolTips.fr['autoStatsSwitch'] = { version: "5.6.24", elementText: "Statistiques", tooltip: "Permet d'activer ou de désactiver autoStats."};
...
HHAuto_ToolTips.fr['autoClubChamp'] = { version: "5.6.24", elementText: "Club", tooltip: "Si activé : combat automatiquement le champion de club si le champion a déjà été affronté une fois."};
...
HHAuto_ToolTips.fr['autoPantheon'] = { version: "6.8.0", elementText: "Panthéon", tooltip: "Si activé : effectue automatiquement le Panthéon."};
...
HHAuto_ToolTips.fr['spendKobans1'] = { version: "5.6.24", elementText: "Vous êtes sûr ?", tooltip: "Deuxième sécurité pour l'utilisation des kobans.<br>Doit être activée après la première.<br>Les 3 doivent être actives pour les fonctions dépensant des kobans."};
HHAuto_ToolTips.fr['spendKobans2'] = { version: "5.6.24", elementText: "Vous êtes prévenu", tooltip: "Troisième sécurité pour l'utilisation des kobans.<br>Doit être activée après la deuxième.<br>Les 3 doivent être actives pour les fonctions dépensant des kobans."};
...
HHAuto_ToolTips.fr['autoChampsForceStartEventGirl'] = { version: "5.6.98", elementText: "Forcer événement", tooltip: "Si activé : combattra pour la fille d'événement du champion même s'il n'est pas commencé. Les champions doivent être activés et le champion présent dans le filtre."};
HHAuto_ToolTips.fr['plusLoveRaid'] = { version: "7.32.1", elementText: "+Raid", tooltip: "Combat les Raids amoureux indépendamment d'Auto Troll et des événements.<br>Les raids passent après les événements mais avant les trolls normaux."};
...
HHAuto_ToolTips.fr['eventMythicPrio'] = { version: "5.6.24", elementText: "Prioritaire sur l'ordre des trolls d'événement", tooltip: "La fille d'événement mythique passe avant l'ordre des trolls d'événement s'il reste des fragments à gagner."};
HHAuto_ToolTips.fr['autoTrollMythicByPassThreshold'] = { version: "5.6.24", elementText: "Mythique ignore le seuil", tooltip: "Autorise le mythique à ignorer le seuil des trolls."};
...
HHAuto_ToolTips.fr['autoSideQuest'] = { version: "5.6.83", elementText: "Quêtes secondaires", tooltip: "Si activé : effectue automatiquement la prochaine quête secondaire disponible (la quête principale activée est prioritaire sur les quêtes secondaires)."};
...
HHAuto_ToolTips.fr['menuDistribution'] = { version: "5.6.24", elementText: "Objets à utiliser : ", tooltip: ""};
HHAuto_ToolTips.fr['Total'] = { version: "5.6.24", elementText: "Total : ", tooltip: ""};
HHAuto_ToolTips.fr['menuAllowedExceed'] = { version: "5.6.42", elementText: "Autoriser un dépassement de : ", tooltip: ""};
HHAuto_ToolTips.fr['menuDistributed'] = { version: "5.6.24", elementText: "Objets utilisés : ", tooltip: ""};
...
HHAuto_ToolTips.fr['upradable'] = { version: "8.10.0", elementText: "Améliorable", tooltip: ""};
...
HHAuto_ToolTips.fr['giveAllaffection'] = { version: "6.2.0", elementText: "Donner toute l'affection", tooltip: "Donne automatiquement toute l'affection à la fille sélectionnée."};
...
HHAuto_ToolTips.fr['autoGiveAff'] = { version: "5.6.24", elementText: "Don automatique", tooltip: "Si activé : donnera automatiquement de l'affection aux filles dans l'ordre (vous pouvez utiliser le script OCD pour filtrer)."};
HHAuto_ToolTips.fr['autoGiveExp'] = { version: "5.6.24", elementText: "Don automatique", tooltip: "Si activé : donnera automatiquement de l'expérience aux filles dans l'ordre (vous pouvez utiliser le script OCD pour filtrer)."};
HHAuto_ToolTips.fr['autoPantheonTitle'] = { version: "5.6.24", elementText: "Panthéon", tooltip: ""};
HHAuto_ToolTips.fr['autoLabyrinth'] = { version: "7.19.0", elementText: "Labyrinthe", tooltip: "Si activé : effectue automatiquement le Labyrinthe en mode simple.<br/>Choisira l'adversaire le plus facile sans anticiper les étapes suivantes."};
...
HHAuto_ToolTips.fr['autoLabyrinthBuildTank'] = { version: "7.9.0", elementText: "Tanks", tooltip: "Choisit deux tanks pour la première ligne."};
HHAuto_ToolTips.fr['autoLabyrinthBuildMage'] = { version: "7.9.0", elementText: "Mages", tooltip: "Choisit deux mages pour la ligne du milieu."};
HHAuto_ToolTips.fr['autoLabyrinthBuildAttack'] = { version: "7.9.0", elementText: "Attaque", tooltip: "Choisit deux filles de dégâts pour la ligne arrière et une pour celle du milieu."};
...
HHAuto_ToolTips.fr['buttonSaveOpponent'] = { version: "5.6.24", elementText: "Enregistrer les données de l'adversaire", tooltip: "Enregistre les données de l'adversaire pour simuler des combats dans le marché."};
HHAuto_ToolTips.fr['SimResultMarketButton'] = { version: "5.6.24", elementText: "Résultats sim.", tooltip: "Simule le résultat avec l'adversaire de ligue enregistré."};
HHAuto_ToolTips.fr['simResultMarketPreviousScore'] = { version: "5.6.24", elementText: "Score précédent :", tooltip: ""};
HHAuto_ToolTips.fr['simResultMarketScore'] = { version: "5.6.24", elementText: "Score : ", tooltip: ""};
...
HHAuto_ToolTips.fr['autoDailyGoals'] = { version: "7.20.0", elementText: "Activer", tooltip: "BÊTA : effectue les objectifs quotidiens pris en charge <br>(pour l'instant : Panthéon)."};
HHAuto_ToolTips.fr['DateAcquired'] = { version: "5.6.56", elementText: "Date de recrutement", tooltip: ""};
HHAuto_ToolTips.fr['Grade'] = { version: "5.6.56", elementText: "Grade", tooltip: ""};
HHAuto_ToolTips.fr['Level'] = { version: "5.6.56", elementText: "Niveau", tooltip: ""};
HHAuto_ToolTips.fr['Power'] = { version: "5.6.56", elementText: "Puissance", tooltip: ""};
HHAuto_ToolTips.fr['upgrade_cost'] = { version: "5.6.56", elementText: "Coût d'amélioration", tooltip: ""};
...
HHAuto_ToolTips.fr['haremGirlGiveGifts'] = { version: "5.30.0", elementText: "Donner des cadeaux à la fille", tooltip: ""};
