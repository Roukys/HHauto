...
GM_addStyle('#pInfo {padding-left:3px; z-index:1;white-space: pre;position: absolute;right: calc(5% + 50px); left:auto; width:18%; height:auto; top:11%; overflow: hidden; border: 1px solid #ffa23e; background-color: rgba(0,0,0,.5); border-radius: 5px; font-size:8pt; user-select: none; -webkit-user-select: none; -moz-user-select: none;}'
