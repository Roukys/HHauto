...
the field rejected it -- the check behind it had a gap between MB9 and MB11. The
field and the script now read the same definition, so the two cannot drift apart
again.
