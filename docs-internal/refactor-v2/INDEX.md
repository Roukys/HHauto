...
status: in-progress (Phase 1 — Prototyp Scheduler, Session 2 complete)
...
| Feld | Wert |
|------|------|
| Phase | 1 — Prototyp Scheduler (Session 2 complete) |
...
| Nächster Schritt | Phase 1 Session 3 (Handler-Migration handleEventParsing) |
| Blocker | keiner |
...
| 1 | Prototyp Scheduler | in-progress (Session 2 complete) | `03-prototype-spec.md` |
