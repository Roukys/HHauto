...
status: in-progress (Phase 1 — Prototyp Scheduler)
...
| Feld | Wert |
|------|------|
| Phase | 1 — Prototyp Scheduler (Session 1 complete) |
...
| Nächster Schritt | Phase 1 Session 2 (Pipeline-Config + Specs) |
| Blocker | keiner |
...
| 1 | Prototyp Scheduler | in-progress (Session 1 complete) | `03-prototype-spec.md` |
